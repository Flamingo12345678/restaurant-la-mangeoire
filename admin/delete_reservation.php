...
<body style="background:#f7f7f7; min-height:100vh;">
  <div class="admin-nav">Administration – Supprimer une réservation</div>
  <div class="form-container">
    ...
    <?php endif; ?>
    <?php if ($id > 0): ?>
      <form method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette réservation ?');">
