    ...
    if (!check_csrf_token($_POST['csrf_token'] ?? '')) {
      ...
      if (validate_length($nom, 1, 100) && $prix > 0 && validate_length($description, 0, 255)) {
        try {
          ...
          handle_pdo_exception($e, 'modification menu');
  ...
  <div class="form-container">
    ...
    <?php if ($menu): ?>
      <form method="post" autocomplete="off">
        ...
        <input type="text" name="nom" value="<?= e($menu['NomItem'] ?? '') ?>" placeholder="Nom du menu" required maxlength="100">
        <input type="text" name="description" value="<?= e($menu['Description'] ?? '') ?>" placeholder="Description" maxlength="255">
        <input type="number" name="prix" value="<?= e($menu['Prix'] ?? '') ?>" placeholder="Prix" required min="0" step="0.01">
