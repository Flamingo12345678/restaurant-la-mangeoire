          ...
          <?php foreach ($reservations as $r): ?>
            <tr>
              ...
              <td>
                ...
                <a href="#" class="edit-btn" data-id="<?= $r['ReservationID'] ?>" data-nom="<?= e($r['nom_client']) ?>" data-email="<?= e($r['email_client']) ?>" data-date="<?= e($r['DateReservation']) ?>" data-statut="<?= isset($r['statut']) ? e($r['statut']) : '' ?>" data-nb="<?= e($r['nb_personnes']) ?>" style="margin-left:8px;"><i class="bi bi-pencil"></i></a>
              </td>
            </tr>
            ...
            <tr class="edit-row" id="edit-row-<?= $r['ReservationID'] ?>" style="display:none;background:#e3f2fd;">
              <td colspan="7">
                <form method="post" class="edit-form" style="display:flex;gap:12px;flex-wrap:wrap;align-items:center;">
                  ...
                  <input type="text" name="edit_nom_client" value="<?= e($r['nom_client']) ?>" required placeholder="Nom" style="padding:8px 10px;border-radius:6px;border:1px solid #e0e0e0;">
                  <input type="email" name="edit_email_client" value="<?= e($r['email_client']) ?>" required placeholder="Email" style="padding:8px 10px;border-radius:6px;border:1px solid #e0e0e0;">
                  <input type="datetime-local" name="edit_DateReservation" value="<?= str_replace(' ', 'T', e($r['DateReservation'])) ?>" required style="padding:8px 10px;border-radius:6px;border:1px solid #e0e0e0;">
