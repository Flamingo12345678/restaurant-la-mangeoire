...
<body>
  ...
  <script>
    // Force la suppression de tout overlay, préchargeur, modal, backdrop, et réactive les clics et le scroll
    ...
    // Redirection automatique après 3 secondes si un message de réservation est affiché
    if (document.body.textContent.includes('capacité maximale de la salle serait dépassée') || document.body.textContent.includes('réservation') || document.body.textContent.includes('succès')) {
      setTimeout(function() {
        window.location.href = 'reservations.php'; // Redirigez vers la page souhaitée
      }, 3000);
    }
  </script>
</body>
