            ...
            <tbody>
              <?php foreach ($clients as $c): ?>
                <tr style="background:#fff;">
                  <td style="padding:16px 20px;"><?= e($c['ClientID']) ?></td>
                  <td style="padding:16px 20px;"><?= e($c['Nom']) ?></td>
                  <td style="padding:16px 20px;"><?= e($c['Prenom']) ?></td>
                  <td style="padding:16px 20px;"><?= e($c['Email']) ?></td>
                  <td style="padding:16px 20px;"><?= e($c['Telephone']) ?></td>
