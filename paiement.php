...
if ($paiement_existant) {
    ...
    header('Location: resultat-paiement.php?status=success&commande=' . $commande_id);
    exit;
}
    ...
    <script>
        ...
        document.getElementById('stripe-payment-form').addEventListener('submit', async function(event) {
            ...
            try {
                ...
                if (result.success) {
                    // Succès - rediriger vers resultat
                    window.location.href = `resultat-paiement.php?status=success&type=stripe&commande=${commandeId}&payment_id=${result.payment_id}`;
                    ...
                    if (confirmError) {
                        ...
                        window.location.href = `resultat-paiement.php?status=success&type=stripe&commande=${commandeId}`;
                    }
                } else {
        ...
        document.getElementById('virement-form').addEventListener('submit', async function(event) {
            ...
            try {
                ...
                if (result.success) {
                    window.location.href = `resultat-paiement.php?status=pending&type=virement&commande=${commandeId}&payment_id=${result.payment_id}`;
                } else {
