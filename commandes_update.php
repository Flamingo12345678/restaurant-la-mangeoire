...
if (!checkColumnExists($pdo, 'Commandes', 'PrixUnitaire')) {
    try {
        $pdo->exec("ALTER TABLE Commandes ADD COLUMN PrixUnitaire DECIMAL(10,2) DEFAULT NULL");
...
if (!checkColumnExists($pdo, 'Commandes', 'MontantTotal')) {
    try {
        $pdo->exec("ALTER TABLE Commandes ADD COLUMN MontantTotal DECIMAL(10,2) DEFAULT NULL");
...
if (checkColumnExists($pdo, 'Commandes', 'PrixUnitaire') && checkColumnExists($pdo, 'Commandes', 'MontantTotal')) {
    try {
